...
int main() {
    ...
    //initialize shader
    std::string vShaderPath = R"(H:\Project\ComputerScience\shaders\DynamicTriangle\dynamicTriangle.vsh)";
    std::string fShaderPath = R"(H:\Project\ComputerScience\shaders\DynamicTriangle\dynamicTriangle.fsh)";
