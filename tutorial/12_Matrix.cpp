...
int main() {
    ...
    std::string vsh = "shaders/matrix/color.vsh";
    std::string fsh = "shaders/matrix/color.fsh";
    Shader objectShader(vsh, fsh);

    std::string lVsh = "shaders/matrix/light.vsh";
    std::string lFsh = "shaders/matrix/light.fsh";
    ...
    unsigned int specularMap = loadTexture("texture/matrix.jpg");
