...
int main() {
    ...
    std::string vShader = R"(H:\Project\ComputerScience\shaders\Rectangle\rectangle.vsh)";
    std::string fShader = R"(H:\Project\ComputerScience\shaders\Rectangle\rectangle.fsh)";
