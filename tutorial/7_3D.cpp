...
int main() {
    ...
    GLFWwindow *window = glfwCreateWindow(800, 600, "3D模型正方体", nullptr, nullptr);
    if (window == nullptr) {
        glfwTerminate();
        return -1;
    }
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        //MVP变换
        //模型矩阵，实质为旋转矩阵，将顶点坐标变换为世界坐标，旋转角度随时间变换
        glm::mat4 model = glm::mat4(1.0f);
        model = glm::rotate(model, (float) glfwGetTime(), glm::vec3(0.5f, 1.0f, 1.0f));  //绕x轴
