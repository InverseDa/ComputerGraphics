...
int main() {
    ...
    std::string vsh = "shaders/dotlightAttenuation/object.vsh";
    std::string fsh = "shaders/dotlightAttenuation/object.fsh";
    Shader objectShader(vsh, fsh);
    objectShader.use();

    vsh = "shaders/dotlightAttenuation/light.vsh";
    fsh = "shaders/dotlightAttenuation/light.fsh";
