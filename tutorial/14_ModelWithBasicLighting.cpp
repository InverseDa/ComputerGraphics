...
int main() {
    ...
    std::string vsh = "shaders/modelWithBasicLighting/object.vsh";
    std::string fsh = "shaders/modelWithBasicLighting/object.fsh";
    Shader objectShader(vsh, fsh);

    vsh = "shaders/modelWithBasicLighting/light.vsh";
    fsh = "shaders/modelWithBasicLighting/light.fsh";
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        float R = 10.0f;
        auto theta = glfwGetTime(), fiv = glfwGetTime() * 0.5;
        lightPos.x = R * cos(theta) * cos(fiv);
        lightPos.z = R * cos(theta) * sin(fiv);
        lightPos.y = R * sin(theta);
