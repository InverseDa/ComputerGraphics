...
int main() {
    ...
    GLFWwindow *window = glfwCreateWindow(800, 600, "材质混合", nullptr, nullptr);
    if (window == nullptr) {
        glfwTerminate();
        return -1;
    }
    ...
    std::string vsh = "shaders/texture/mixTexture.vsh";
    std::string fsh = "shaders/texture/mixTexture.fsh";
