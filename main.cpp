...
void init()
{
    ...
    vshader = R"(H:\Project\ComputerScience\shaders\vshader.glsl)";
    fshader = R"(H:\Project\ComputerScience\shaders\fshader.glsl)";
...
int main(int argc, char **argv)
{
    ...
    // 配置窗口属性
    GLFWwindow* window = glfwCreateWindow(512, 512, "Red Triangle", nullptr, nullptr);
    if (window == nullptr)
    {
